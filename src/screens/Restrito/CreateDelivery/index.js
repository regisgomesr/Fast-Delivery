    ...
    return (
      <div className="create-container">
        ...
        {this.props.deliveries.saved && (
          <Segment color="green">Entrega Criada com sucesso!</Segment>
        )}
          ...
          <Form>
            <Form.Field>
              ...
              <input
                ...
                onChange={this.handleChange("name_client")}
            ...
            <Form.Field>
              ...
              <InputPlacesAutocomplete
                ...
                changeAddressCallback={this.handleChangeAddressStart}
              />
            </Form.Field>
            <Form.Field>
              <label>Destino:</label>
              <InputPlacesAutocomplete
                ...
                changeAddressCallback={this.handleChangeAddressDestination}
              />
            </Form.Field>
            <Form.Field>
              ...
              <input
                type="text"
                value={this.state.date.format("DD/MM/YYYY, H:mm:ss")}
            ...
            <div className="div-delivery-save">
              <Button
                inverted
                color="blue"
                size="big"
...
const mapDispatchToProps = (dispatch) => {
  return {
    create: (delivery) =>
      dispatch(ActionCreators.createDeliveryRequest(delivery)),
