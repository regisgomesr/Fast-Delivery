    ...
    return (
      <div>
        {this.props.auth.error && (
          <Segment color="red">Erro - E-mail já existe!</Segment>
        )}
        <Header />
        <h1>Criar Conta</h1>

        {this.state.error === "equal" && (
          <Segment color="red">Erro - Senhas diferentes!</Segment>
        )}
        ...
        {!this.props.auth.saved && (
          <Form>
            ...
            <Button inverted color="blue" size="big" onClick={this.handleSave}>
              Criar Conta
            </Button>
          </Form>
        )}
